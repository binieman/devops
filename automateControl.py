...
left_window = Window()
output_window = Window(BufferControl(buffer=left_buffer))
...
left = HSplit(
    [
        ...
        Window(
            height=1,
            content=FormattedTextControl("COMMAND LINE"),
...
right_window = HSplit(
    [
        ...
        Window(
            height=1,
            content=FormattedTextControl("VM1"),
            align=WindowAlign.CENTER,
        ),
        # Horizontal separator.
        Window(height=1, char="-", style="class:line"),
        ...
        Window(
            height=1,
            content=FormattedTextControl("VM2"),
            align=WindowAlign.CENTER,
        ),
        # Horizontal separator.
        Window(height=1, char="-", style="class:line"),
        ...
        Window(
            height=1,
            content=FormattedTextControl("VM3"),
            align=WindowAlign.CENTER,
        ),
        # Horizontal separator.
        Window(height=1, char="-", style="class:line"),
...
def run():
    ...
    root_container.content = FormattedTextControl('HELLLO')
    application.run()
